...
st.set_page_config(page_title='Gestión Ruteros', 
                   layout='wide', 
                   page_icon='⚡')
...
st.caption("""Módulo para gestionar abonos a ruteros. Este proceso crea una devolución por cada Rutero según precio (02) de los pedidos asociados.""")