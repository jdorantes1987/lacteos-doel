...
#EstadoCuentaRutero(conexion).calculo_ganacia_por_factura_comercio(fecha_d='20241101', fecha_h='20241113').to_excel('calculo_ganacia_por_factura_comercio.xlsx')
...
#NotasEntregaConsultas(conexion).saldo_anterior_notas(fecha_d='20241101', tip_cli='R').to_excel('saldo_anterior_notas.xlsx')
...
#EstadoCuentaRutero(conexion).resumen_movimiento_cuenta().to_excel('resumen_movimiento_cuenta.xlsx')
#EstadoCuentaRutero(conexion).movimiento_cuenta_rutero_x_dia(tip_cli='R').to_excel('movimiento_cuenta_rutero_x_dia.xlsx')
...
#Ajustes(conexion).saldo_anterior_ganancias_aplicadas(fecha_d='20241101', fecha_h='20241114').to_excel('saldo_anterior_ganancias_aplicadas.xlsx')
#Ajustes(conexion).documentos_ajustes().to_excel('documentos_ajustes.xlsx')
