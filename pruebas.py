...
#Inventario(conexion).movimiento_inventario_x_articulo().to_excel('movimiento_inventario_x_articulo.xlsx')
# Inventario(conexion).movimiento_inventario_x_articulo().to_excel('movimiento_inventario_x_articulo.xlsx')
...
#FacturaVentasConsultas(conexion).data_factura_venta_con_detalle(anio='all', mes='all').to_excel('data_factura_venta_con_detalle.xlsx')
#NotasEntregaConsultas(conexion).data_notas_entrega_con_detalle(anio='all', mes='all').to_excel('data_notas_entrega_con_detalle.xlsx')
